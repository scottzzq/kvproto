...
type CmdPrewriteRequest struct {
	...
	FastInsert       bool   `protobuf:"varint,4,opt,name=fast_insert,json=fastInsert" json:"fast_insert"`
	XXX_unrecognized []byte `json:"-"`
}
...
func (m *CmdPrewriteRequest) GetFastInsert() bool {
	if m != nil {
		return m.FastInsert
	}
	return false
...
type CmdCommitRequest struct {
	...
	FastInsert       bool     `protobuf:"varint,5,opt,name=fast_insert,json=fastInsert" json:"fast_insert"`
	XXX_unrecognized []byte   `json:"-"`
}
...
func (m *CmdCommitRequest) GetFastInsert() bool {
	if m != nil {
		return m.FastInsert
	}
	return false
...
func (m *CmdPrewriteRequest) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FastInsert", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorKvrpcpb = []byte{
	...
	,
}
