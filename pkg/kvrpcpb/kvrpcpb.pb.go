...
type CmdGCRequest struct {
	...
	NextSafePointHint uint64 `protobuf:"varint,2,opt,name=next_safe_point_hint,json=nextSafePointHint" json:"next_safe_point_hint"`
	XXX_unrecognized  []byte `json:"-"`
}
...
func (m *CmdGCRequest) GetNextSafePointHint() uint64 {
	if m != nil {
		return m.NextSafePointHint
	}
	return 0
}
...
func (m *CmdGCRequest) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0x10
	i++
	i = encodeVarintKvrpcpb(data, i, uint64(m.NextSafePointHint))
	if m.XXX_unrecognized != nil {
		i += copy(data[i:], m.XXX_unrecognized)
	}
	return i, nil
...
func (m *CmdGCRequest) Size() (n int) {
	...
	n += 1 + sovKvrpcpb(uint64(m.NextSafePointHint))
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	return n
...
func (m *CmdGCRequest) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NextSafePointHint", wireType)
			}
			m.NextSafePointHint = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowKvrpcpb
				}
				...
				b := data[iNdEx]
				iNdEx++
				m.NextSafePointHint |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorKvrpcpb = []byte{
	...
	,
}
