...
type Needle struct {
	MagicNum         *uint64 `protobuf:"varint,1,opt,name=magic_num,json=magicNum" json:"magic_num,omitempty"`
	Size_            *uint64 `protobuf:"varint,2,opt,name=size" json:"size,omitempty"`
	Key              *uint64 `protobuf:"varint,3,opt,name=key" json:"key,omitempty"`
...
func (*Needle) Descriptor() ([]byte, []int) { return fileDescriptorMetapb, []int{6} }

func (m *Needle) GetMagicNum() uint64 {
	if m != nil && m.MagicNum != nil {
		return *m.MagicNum
	}
	return 0
}

func (m *Needle) GetSize_() uint64 {
...
func init() {
	...
	proto.RegisterType((*Needle)(nil), "metapb.Needle")
...
func (m *Needle) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *Needle) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.MagicNum != nil {
		dAtA[i] = 0x8
		i++
		i = encodeVarintMetapb(dAtA, i, uint64(*m.MagicNum))
	}
	if m.Size_ != nil {
		dAtA[i] = 0x10
		i++
		i = encodeVarintMetapb(dAtA, i, uint64(*m.Size_))
	}
	if m.Key != nil {
		dAtA[i] = 0x18
		i++
		i = encodeVarintMetapb(dAtA, i, uint64(*m.Key))
	}
	if m.Value != nil {
		dAtA[i] = 0x22
		i++
...
func (m *Needle) Size() (n int) {
	var l int
	_ = l
	if m.MagicNum != nil {
		n += 1 + sovMetapb(uint64(*m.MagicNum))
	}
	if m.Size_ != nil {
		n += 1 + sovMetapb(uint64(*m.Size_))
	}
	if m.Key != nil {
		n += 1 + sovMetapb(uint64(*m.Key))
	}
	if m.Value != nil {
		l = len(m.Value)
		n += 1 + l + sovMetapb(uint64(l))
...
func (m *Needle) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Needle: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Needle: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MagicNum", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorMetapb = []byte{
	...
	,
}
